...
func _physics_process(delta):
	...
	if visible:
		...
		var character_pos = get_parent().get_parent().global_position
...
func update_connection_line():
	...
	var local_char_pos = to_local(get_parent().get_parent().global_position)
